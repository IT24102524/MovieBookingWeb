...
<div class="container">
  ...
  <a href="users?action=registerForm" class="btn-register">Register New User</a>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td data-label="Name"><%= u.getName() %></td>
        <td data-label="Email"><%= u.getEmail() %></td>
        <td data-label="Actions">
          <a href="users?action=editForm&id=<%= u.getUserId() %>" class="btn-primary">Edit</a>
          <a href="users?action=deleteConfirm&id=<%= u.getUserId() %>" class="btn-danger ms-1"
