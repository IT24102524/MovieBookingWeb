...
<nav class="navbar">
  ...
  <ul>
    ...
    <li class="nav-item">
                       <a class="nav-link-active" aria-current="page" href="${pageContext.request.contextPath}/admin/dashboard.jsp">Dashboard</a>
            </li>
...
<div class="container">
  ...
  <p class="welcome">Welcome, <strong><%= currentUser.getName() %></strong>!</p>

  <div class="admin-list">
    <a href="<c:url value='/movies' />">Manage Movies</a>
    <a href="<c:url value='/users' />">Manage Users</a>
    <a href="<c:url value='/bookings' />">Manage Bookings</a>
  </div>
</div>
